...
trigger_transformation_databricks = DatabricksSubmitRunOperator(
    ...
    json={
         "tasks": [{
            ...
            "notebook_task": {
                "notebook_path": "" #Put your notebook path here. for eg /Workspace/Users/nasirkadri2601@gmail.com/Worksheetname
            },
            "existing_cluster_id": ""  # Put your databricks cluster Id here. Ensure this is a valid, active cluster ID
        }]
    },
    dag=dag
)
